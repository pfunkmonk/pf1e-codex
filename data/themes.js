...
window.PF_THEMES = {
  ...
  feats: [
    ...
    ["sunder",            /\bsunder|\bshatter/i,                          /\bsunder\b/i, 4],
    ["grapple",           /\bgrappl|\bpin\b|\bconstrict|\bchokehold|\bstrangl/i, /\bgrapple[ds]?\b/i, 7],
    ...
    ["feint",             /\bfeint|\bmisdirect/i,                         /\bfeint\b/i, 5],
    ["maneuver-general",  /\bmaneuver|\bagile maneuvers\b/i,              /\bcombat maneuver (bonus|defense)\b/i, 2],
    // --- attack styles ---
    ["power-attack",      /\bpower attack|\bfurious|\bcleave|\bsmash|\bcrush|\bmighty\b/i, /\bpower attack\b/i, 10],
    ["vital-strike",      /\bvital strike|\bdevastat|\bstrike$/i,         /\bvital strike\b/i, 12],
    ["two-weapon",        /\btwo-weapon|\bdouble\b|\bambidext|\bdual\b/i, /\btwo-weapon fighting\b/i, 4],
    ["finesse-duelist",   /\bfinesse|\bgrace\b|\bfencing|\bduel|\bswashbuck|\bpanache|\briposte|\bparry/i, /\bweapon finesse\b|\bpanache\b/i, 7],
    ["archery",           /\bshot\b|\barcher|\bbow\b|\bmanyshot|\bdeadly aim|\bvolley|\barrow|\bfletch/i, /\bpoint.blank shot\b/i, 17],
    ["thrown",            /\bthrow(n|ing)?\b|\bjuggl|\bhurl|\bsling\b/i,  /\bthrown weapon\b/i, 5],
    ["firearms",          /\bfirearm|\bgun\b|\bpistol|\bmusket|\bgrit\b|\bammo|\bartillery|\bcartridge/i, /\bfirearm|\bgrit\b/i, 5],
    ["charge",            /\bcharge\b|\bspirited|\blance\b/i,             /\bwhen you charge\b/i, 5],
    ["mounted",           /\bmounted|\bride\b|\briding|\bcavalry|\bhorse|\bsaddle|\bsteed/i, /\bmounted\b/i, 4],
    ["critical-hit",      /\bcritical\b|\bstagger|\bstunning|\bbleeding|\bmaiming/i, /\bcritical hit\b/i, 12],
    ["attacks-of-opp",    /\bopportun|\bcombat patrol|\bcombat reflexes|\bstep up|\bspellbreaker|\bdisruptive/i, /\battacks? of opportunity\b/i, 7],
    ["combat-expertise",  /\bcombat expertise|\bexpertise\b|\bdefensive\b/i, /\bcombat expertise\b/i, 5],
    ["dodge-mobility",    /\bdodge|\bmobility|\bstance\b|\bnimble|\bevasi|\belusive/i, /\bdodge bonus\b/i, 5],
    ["reach-polearm",     /\breach\b|\blunge|\bpolearm|\bphalanx|\bspear/i, /\breach weapon\b/i, 2],
    // --- defence ---
    ["shield",            /\bshield|\bbash\b|\bbuckler|\bbulwark/i,       /\bshield bonus\b/i, 10],
    ["armor",             /\barmor|\bplate\b|\bmail\b|\bharness/i,        /\barmor check penalty\b/i, 8],
    ["toughness-saves",   /\btoughness|\bendur|\bdiehard|\bfortitude|\biron will|\breflexes|\bresilien|\bstalwart|\bhardy/i, /\bhit points\b/i, 9],
    // --- unarmed / monk ---
    ["monk-style",        /\bstyle\b/i,                                    /\bstyle feat\b/i, 14],
    ["unarmed",           /\bunarmed|\bpunch|\bkick\b|\bfist\b|\bbrawl|\bmartial arts|\bblow\b|\bgrab\b/i, /\bunarmed strike\b/i, 10],
    ["ki-meditation",     /\bki\b|\bqinggong|\bmeditat|\bascetic|\bmonastic/i, /\bki pool\b/i, 6],
    // --- magic ---
    ["metamagic",         /\bspell$|\bmetamagic|\bquicken|\bempower|\bmaximize|\bwiden|\bstill spell|\bsilent spell|\bextend|\benlarge|\bheighten|\bpersistent/i, /\bmetamagic\b/i, 28],
    ["spell-focus",       /\bspell focus|\bspell specialization|\bspell penetration|\bspell perfection|\bfocus$/i, /\bspell focus\b|\bspell penetration\b/i, 7],
    ["counterspell",      /\bcounterspell|\bdispel|\bnullif|\bantimagic/i, /\bcounterspell\b/i, 2],
    ["summoning",         /\bsummon|\bconjur|\bgate\b/i,                   /\bsummon monster\b/i, 6],
    ["familiar",          /\bfamiliar|\btumor\b/i,                         /\bfamiliar\b/i, 7],
    ["animal-companion",  /\bcompanion|\bboon companion|\bpack\b/i,        /\banimal companion\b/i, 8],
    ["bloodline",         /\bbloodline|\bheritage|\bdraconic|\babyssal\b/i, /\bbloodline\b/i, 5],
    ["channel-energy",    /\bchannel|\bturn undead|\bcommand undead/i,     /\bchannel energy\b/i, 9],
    ["hex-witch",         /\bhex\b|\bwitch|\bcackle|\bcauldron|\bcoven/i,  /\bhex\b/i, 4],
    ["rage-barbarian",    /\brag(e|ing)\b|\bbarbarian|\bfury|\bberserk|\bferocious|\bsavage/i, /\brage powers?\b/i, 7],
    ["bardic",            /\bbard\b|\bperform|\bsong\b|\bmasterpiece|\blingering|\bmelod|\bharmon|\bdirge/i, /\bbardic performance\b/i, 8],
    ["smite-paladin",     /\bsmite|\bpaladin|\blay on hands|\bmercy\b|\blitany|\bcrusad|\bchampion/i, /\bsmite evil\b|\blay on hands\b/i, 5],
    ["judgment-teamwork", /\bjudgment|\binquisit|\bbane\b|\bteamwork|\bcoordinat|\bpaired\b|\bgang\b/i, /\bteamwork feat\b|\bjudgment\b/i, 13],
    ["arcane",            /\barcane|\beldritch|\bmage\b|\bwizard|\bsorcer|\barcanist/i, /\barcane strike\b/i, 7],
    ["mesmerist-stare",   /\bstare\b|\bmesmer|\bhypnot|\bgaze\b/i,         /\bpainful stare\b/i, 3],
    ["psychic-occult",    /\bpsychic|\boccult|\bphrenic|\bmind\b|\btelepath|\bthought|\bmental|\bmindscape|\balien\b/i, /\bpsychic magic\b/i, 14],
    ["spirit-medium",     /\bspirit|\bmedium\b|\bshaman|\bseance|\bhaunt|\bwander/i, /\bspirit\b/i, 11],
    ["necromancy",        /\bundead|\bnecro|\bcorpse|\bghoul|\bzombie|\bskeleton|\bbone\b|\bgrave\b|\bdeath\b/i, /\bundead\b/i, 12],
    ["shadow",            /\bshadow|\bdark|\bnight\b|\bumbral|\bgloom/i,   /\bshadow\b/i, 10],
    ["planar",            /\bplanar|\bextraplanar|\bdemon|\bdevil|\bangel|\bcelestial|\bfiend|\bdamn|\bdimension|\binfernal|\babyss|\basura/i, /\bextraplanar\b/i, 10],
    // --- elemental ---
    ["fire",              /\bfire|\bflame|\bburn|\bblaz|\bcinder|\bpyro|\bash\b|\bsmoke/i, /\bfire damage\b/i, 17],
    ["cold",              /\bcold|\bfrost|\bice\b|\bfrozen|\bwinter|\brime\b|\barctic/i, /\bcold damage\b/i, 4],
    ["lightning",         /\blightning|\belectric|\bthunder|\bstorm|\bshock/i, /\belectricity damage\b/i, 3],
    ["acid-poison",       /\bacid|\bcorros|\bvenom|\bpoison|\btoxic|\bsting/i, /\bacid damage\b|\bpoison\b/i, 17],
    ["earth-stone",       /\bstone|\bearth|\bmountain|\bgranite|\bboulder|\bcrystal|\bmetal\b|\biron\b|\bsteel/i, /\bstone\b/i, 9],
    ["air-flight",        /\bwind\b|\bair\b|\bsky\b|\bcloud|\bflight|\bfly\b|\bwing|\baerial|\bsoar|\baltitude/i, /\bfly speed\b/i, 6],
    ["water",             /\bwater|\baqua|\bswim|\bsea\b|\bocean|\btide\b|\bwave\b|\bmarine|\bnaut/i, /\bswim speed\b/i, 6],
    // --- skills & social ---
    ["stealth",           /\bstealth|\bhide\b|\bsneak|\bcamouflage|\bvanish|\bsilent\b|\bambush|\bassassin/i, /\bstealth check\b|\bsneak attack\b/i, 7],
    ["intimidate",        /\bintimidat|\bdemoral|\bfear\b|\bterrif|\bdread|\bcornugon|\bmenac|\bfright|\bhorror/i, /\bintimidate check\b|\bdemoralize\b/i, 8],
    ["diplomacy",         /\bdiplomac|\bpersuas|\bnegotiat|\bcharm|\bcourt|\bnoble|\betiquette|\bfriend/i, /\bdiplomacy check\b/i, 9],
    ["bluff-disguise",    /\bbluff|\bdecei|\bdisguise|\blie\b|\bmask\b|\bimperson|\bswindl/i, /\bbluff check\b/i, 3],
    ["perception",        /\bpercept|\bsense\b|\balert|\bkeen\b|\bsharp|\bwatch|\bscout|\bwarning|\bsight\b/i, /\bperception check\b/i, 6],
    ["knowledge",         /\bknowledge|\blore\b|\bscholar|\bstud(y|ent|ied)|\bresearch|\bsavant|\bgraduate|\bacadem|\bsage\b|\bastrolog/i, /\bknowledge \(/i, 21],
    ["athletics",         /\bclimb|\bscal(e|ing)|\bathlet|\bjump|\bleap|\btumbl|\brun\b|\bsprint|\bacrobat|\bascen/i, /\bclimb speed\b|\bacrobatics check\b/i, 7],
    ["heal-medicine",     /\bheal|\bmedic|\bsurgeon|\bchirurg|\bacupunct|\banatom|\bremed/i, /\bheal check\b/i, 4],
    ["survival",          /\bsurvival|\btrack|\bforag|\bwilder|\bhunt|\btrapper|\bnomad|\bexplor|\badaptation/i, /\bsurvival check\b/i, 6],
    ["traps-thievery",    /\btrap|\bdisable|\block\b|\bthief|\bpick\b|\bburgl/i, /\bdisable device\b/i, 14],
    ["leadership",        /\bleader|\bcommand|\bcaptain|\btactic|\brally|\binspir|\ballied|\bassociate|\bpartner|\bteam\b/i, /\bleadership\b|\bcohort\b/i, 10],
    ["linguistics",       /\blinguist|\blanguage|\bscript|\bcipher|\btongue|\bglyph/i, /\blinguistics\b/i, 3],
    // --- crafting ---
    ["item-creation",     /\bcraft|\bforge\b|\bscribe|\bbrew|\bconstruct|\bcreate|\bartis|\bsmith/i, /\bitem creation\b/i, 11],
    ["alchemy",           /\balchem|\bbomb|\bmutagen|\bextract|\bdiscover|\belixir|\bpotion|\bdrug/i, /\balchemist\b|\bbombs?\b/i, 5],
    ["item-mastery",      /\bitem mastery/i,                               /\bitem mastery\b/i, 2],
    // --- creature / racial ---
    ["natural-attacks",   /\bbite\b|\bclaw|\bgore\b|\bnatural\b|\btail\b|\bhoof|\btalon|\brend\b|\bmaul|\bfang/i, /\bnatural attacks?\b/i, 8],
    ["dragon-breath",     /\bbreath\b|\bdragon/i,                          /\bbreath weapon\b/i, 6],
    ["race-dwarf",        /\bdwar/i,                                       /\bdwarf\b/i, 2],
    ...
    ["race-giant",        /\bgiant|\bogre\b|\btroll/i,                     /\bgiant\b/i, 2],
    // --- misc ---
    ["initiative-speed",  /\binitiative|\bquick\b|\bfast\b|\bswift\b|\bspeed\b|\bfleet\b|\bsudden|\bhast/i, /\binitiative check\b/i, 4],
    ["extra-resource",    /\bextra\b|\badditional\b|\bexpanded|\babundant/i, /\badditional uses\b/i, 11],
    ["story-destiny",     /\bstory\b|\bdestiny|\bfate\b|\bvengeance|\bredempt|\bascend|\blegacy|\bheir\b|\bbirthright|\bapotheosis/i, /\bstory feat\b/i, 3],
    ["faith-obedience",   /\bobedience|\bboon\b|\bevangel|\bexalted|\bsentinel|\bdeific|\bfaith|\bpray|\bholy|\bsacred|\bbless|\bpious|\bpilgrim|\breligio|\bdivine|\btemple|\bsaint|\bpurity/i, /\bdeific obedience\b|\bdeity\b/i, 14],
    ...
    ["curse-disease",     /\bcurse|\bdisease|\bplague|\bblight|\brot\b|\binfect/i, /\bcursed?\b|\bdisease\b/i, 13],
    ["light-radiance",    /\blight\b|\bradian|\bsun\b|\bdawn\b|\bbright|\bglow|\blumin/i, /\bbright light\b/i, 2],
    ["blood-sacrifice",   /\bblood|\bsacrific|\bwound|\bscar\b|\bpain\b|\bmartyr/i, /\bhit point damage\b/i, 8],
    ["multiclass-dabble", /\bamateur|\bdabbl|\bapprentic|\bnovice|\binitiate|\bstudent\b/i, /\bcount as .* levels?\b/i, 2],
    // LAST and NARROW on purpose. See the ordering note at the top of this file.
    ["weapon-training",   /\bweapon|\bsword|\bblade\b|\bproficien|\btraining\b|\bmartial\b/i, /\bweapon training\b|\bproficiency\b/i, 14]
  ],
  ...
  items: [
    ["firearm-ammo",    /\bcartridge|\bbullet|\bpellet|\bblack powder|\bshot\b/i, null, 6],
    ["arrow-bolt",      /\barrow|\bbolt\b|\bquiver|\bshuriken|\bdart\b|\bammunition/i, null, 10],
    ...
    ["blade-sword",     /\bsword|\bblade\b|\brapier|\bscimitar|\bfalchion|\bkatana|\bsabre|\bsaber|\bcutlass|\bestoc/i, null, 12],
    ["blade-dagger",    /\bdagger|\bknife|\bkukri|\bdirk\b|\bstiletto|\bkerambit/i, null, 3],
    ["axe",             /\baxe\b|\bhatchet|\bbardiche/i, null, 2],
    ["bludgeon",        /\bhammer|\bmace\b|\bclub\b|\bflail|\bmaul\b|\bmorningstar|\bcudgel|\bquarterstaff|\bnunchaku|\bsap\b/i, null, 6],
    ["polearm-spear",   /\bspear|\bpike\b|\blance\b|\btrident|\bscythe|\bpolearm|\branseur|\bguisarme|\bnaginata|\bhalberd|\bglaive/i, null, 6],
    ["exotic-weapon",   /\bwhip|\bnet\b|\bbolas|\bchakram|\bkusari|\burumi|\baklys|\batlatl|\bboomerang|\bgarrote/i, null, 3],
    ["weapon-quality",  /\bbane\b|\bkeen\b|\bflaming|\bfrost\b|\bshock|\bcorrosive|\bvorpal|\bbrilliant|\bdancing|\bdefending|\bthundering|\bwounding|\bseeking|\bdistance|\bmerciful|\bmighty|\bagile\b|\badaptive/i, null, 6],
    ...
    ["shield-item",     /\bshield|\bbuckler|\btarge|\baegis/i, null, 9],
    ["barding-tack",    /\bbarding|\bsaddle|\bbridle|\bharness|\bstirrup|\bhorseshoe|\byoke\b/i, null, 4],
    ["ioun-stone",      /\bioun/i, null, 5],
    ["ring-item",       /\bring\b/i, null, 32],
    ["amulet-neck",     /\bamulet|\bnecklace|\bperiapt|\btorc\b|\bpendant|\bbrooch|\bmedallion|\bscarab|\bcollar|\bchoker/i, null, 10],
    ["cloak-cape",      /\bcloak|\bcape\b|\bmantle|\bshawl|\bwrap\b/i, null, 9],
    ["boots-footwear",  /\bboots|\bshoes|\bslippers|\bsandals|\bgreaves|\banklets/i, null, 7],
    ["gloves-bracers",  /\bgloves|\bgauntlet|\bbracers|\bvambrace|\bmitt|\bwristband/i, null, 13],
    ["belt-girdle",     /\bbelt\b|\bgirdle|\bsash\b/i, null, 5],
    ["helm-crown",      /\bhelm|\bcrown|\bcirclet|\bdiadem|\btiara|\bcoronet/i, null, 7],
    ...
    ["robe-vestment",   /\brobe\b|\bvest\b|\btunic|\bgarb\b|\bshirt|\bcoat\b|\bjacket|\bdress\b|\bgown\b|\bapron|\bcostume|\bcorset/i, null, 12],
    ["wand",            /\bwand\b/i, null, 1],
    ["staff",           /\bstaff\b|\bstave/i, null, 9],
    ["rod-scepter",     /\brod\b|\bscepter|\bsceptre|\bcane\b|\bbaton/i, null, 18],
    ["figurine-idol",   /\bfigurine|\bstatuette|\bstatue|\bidol\b|\bdoll\b|\bpuppet|\beffigy|\btotem|\bfetish|\bicon\b/i, null, 4],
    ["orb-sphere",      /\borb\b|\bsphere|\bglobe|\bcrystal ball|\bmarble|\bbead\b/i, null, 3],
    ...
    ["book-scroll",     /\bbook\b|\btome\b|\bgrimoire|\blibram|\bmanual|\bcodex|\bfolio|\bscroll|\bspellbook|\bjournal|\bledger/i, null, 6],
    ["mirror-lens",     /\bmirror|\blooking glass|\bprism/i, null, 2],
    ["horn-instrument", /\bhorn\b|\bdrum\b|\bflute|\bharp\b|\blute\b|\bpipes|\bfiddle|\bviol\b|\blyre|\bmandolin|\binstrument|\bwhistle/i, null, 6],
    ...
    ["gem-stone",       /\bstone\b|\bgem\b|\bpearl|\bcrystal|\bdiamond|\bruby|\bemerald|\bsapphire|\bopal\b|\bjade\b|\bamber|\bagate|\bquartz/i, null, 7],
    ...
    ["carpet-banner",   /\bcarpet|\brug\b|\bbroom|\bmat\b|\btapestry|\bbanner|\bflag\b|\bstandard\b/i, null, 3],
    ...
    ["deck-game",       /\bdeck\b|\bcard\b|\bharrow|\bdice\b|\bgame\b|\bpuzzle/i, null, 2],
    ["talisman-charm",  /\btalisman|\bcharm\b|\bward\b|\bsigil|\brune\b|\bphylactery/i, null, 4],
    ...
    ["poison-drug",     /\bpoison|\bvenom|\btoxin|\bdrug\b|\bnarcotic|\bopium|\bpesh\b|\bsalve|\bointment/i, null, 4],
    ...
    ["writing-paper",   /\bink\b|\bquill|\bpaper|\bparchment|\bvellum|\bwax\b|\bseal\b|\bstylus|\bslate\b|\bpen\b/i, null, 4],
    ...
    ["optical-device",  /\bglass\b|\bhourglass|\bspyglass|\btelescope|\bcompass|\bsextant|\bastrolabe|\bsundial/i, null, 3],
  ...
  spells: [
    ...
    ["healing",       /\bcure\b|\bheal\b|\bhealing|\brestor|\bregenerat|\bremove |\bmend\b|\bneutralize|\bsoothe|\bclose wounds/i, /\(healing\)/i, 13],
    ["undead",        /\banimate dead|\bundead|\bzombie|\bskeleton|\bghoul|\bwight|\bvampir|\blich|\bnecro|\bcorpse|\bgrave\b|\bslay living|\bdeath knell/i, /\[[^\]]*death/i, 7],
    ["summoning",     /\bsummon|\bplanar ally|\bplanar bind|\bgate\b|\binstant summons|\bcall\b/i, /\((summoning|calling)\)/i, 18],
    ["teleport",      /\bteleport|\bdimension|\btranslocat|\bblink\b|\bshadow walk|\bword of recall|\btransport|\bphase\b|\bethereal jaunt/i, /\(teleportation\)/i, 7],
    ["divination",    /\bdetect |\bscry|\bdivination|\baugury|\bcommune|\bforesight|\bclairvoy|\bidentify|\blocate|\btrue seeing|\bread \b|\bvision\b|\bprying eyes/i, /\(scrying\)/i, 7],
    ["illusion",      /\billusion|\bimage\b|\bphantasm|\bmirage|\bglamer|\binvisib|\bblur\b|\bdisplace|\bmislead|\bveil\b|\bhallucinat|\bsilent image|\bdisguise/i, /\((glamer|figment|phantasm|pattern|shadow)\)/i, 26],
    ...
    ["charm-mind",    /\bsuggestion|\bhideous laughter|\benthrall|\bgeas|\bmodify memory|\bcalm emotions/i, /((compulsion|charm))/i, 34],
    ["fear",          /\bfear\b|\bterror|\bhorror|\bscare\b|\bcause fear|\bdoom\b|\bphantasmal killer|\bnightmare|\bpanic|\bbane\b/i, /[[^]]*fear|(fear)/i, 7],
    ["sleep-daze",    /\bsleep\b|\bdaze\b|\bslumber|\bunconscious|\bstun\b|\bhypnot|\bdeep slumber/i, /(sleep)|[[^]]*sleep/i, 2],
    ["polymorph",     /\bform\b|\bpolymorph|\bshape\b|\btransform|\bmetamorph|\bbeast shape|\balter self|\banimal aspect|\bgrowth\b|\benlarge|\breduce\b|\bsize\b/i, /\(polymorph\)/i, 17],
    ["protection",    /\bprotect|\bshield\b|\bward\b|\bsanctuary|\bresist|\bguard|\bbarrier|\bsafeguard|\bimmunity|\bendure|\bdeflect|\bfreedom\b/i, null, 14],
    ["wall-barrier",  /\bwall of|\bwall\b|\bfog\b|\bcloud\b|\bweb\b|\bentangle|\bgrease|\btentacles|\bspike\b|\bmire\b/i, null, 10],
    ["weapon-buff",   /\bweapon\b|\bblade\b|\bsword|\bmagic weapon|\bkeen\b|\bflame blade|\bspiritual|\barrow|\bshot\b|\bmissile/i, null, 19],
    ["armor-buff",    /\barmor\b|\bbarkskin|\bmage armor|\bstoneskin|\bnatural armor|\bshield of faith/i, null, 4],
    ["movement",      /\bfly\b|\bflight|\blevitat|\bfeather fall|\bexpeditious|\bspider climb|\bair walk|\bwind walk|\bjump\b|\bhaste\b|\bslow\b|\bspeed\b|\blongstrider|\bstride/i, null, 3],
    ...
    ["curse-affliction",/\bcurse|\bbestow|\bblind|\bdeaf|\bdisease|\bcontagion|\bpoison|\bfeeblemind|\bwaves of|\bbaleful|\bmark of/i, /\[[^\]]*(curse|disease|poison|pain)/i, 20],
    ["light-dark",    /\blight\b|\bdaylight|\bdarkness|\bsunburst|\bsunbeam|\bglow\b|\bflare\b|\bblindness|\bshadow|\bgloom/i, /\[[^\]]*(light|darkness)/i, 21],
    ...
    ["fire",          /\bfire\b|\bincinerat|\bscorch|\bfirebrand/i, /\[[^\]]*fire/i, 18],
    ["cold",          /\bcold\b|\bwinter|\brime\b|\bsnow/i, /\[[^\]]*cold/i, 7],
    ["lightning",     /\blightning|\belectric|\bthunder|\bshock|\bstorm\b/i, /\[[^\]]*electricity/i, 10],
    ["acid",          /\bacid\b|\bcorros|\bmelt\b|\bdissolv/i, /\[[^\]]*acid/i, 4],
    ...
    // than being lost.
    ["sonic",         /\bsound\b|\bsonic|\bshout|\bscream|\bshriek|\bnoise|\bsilence|\bcacoph/i, /\[[^\]]*sonic/i, 6],
    ...
    ["force",         /\bforce\b|\btelekine|\bbattering/i, /\[[^\]]*force/i, 11],
    ...
    ["earth-stone",   /\bstone\b|\bearth\b|\brock\b|\bmeld\b|\bsoften|\bmove earth|\bmetal\b|\biron\b(?!\s+will)|\bcrystal/i, /\[[^\]]*earth/i, 13],
    ["plant-nature",  /\bplant\b|\btree\b|\bwood\b|\bvine\b|\bthorn|\bbriar|\bgrove|\bnature|\bbloom|\brusting grasp|\bshillelagh|\bgoodberry/i, null, 4],
    ["animal",        /\banimal|\bbeast\b|\bvermin|\bswarm|\bmagic fang|\bbite\b|\bcharm animal|\bhold animal|\bspeak with animals/i, null, 5],
    ...
    ["weather",       /\bweather|\bwind\b|\bsleet|\bhail\b|\bcontrol winds|\bgust\b|\bfog cloud/i, /\[[^\]]*air/i, 6],
    ["water",         /\bwater\b|\baqua|\bocean|\bsea\b|\btide\b|\bwave\b|\bdrown|\bswim/i, /\[[^\]]*water/i, 8],
    ["symbol-rune",   /\bsymbol\b|\brune\b|\bglyph|\bsigil|\bexplosive runes|\bsepia|\bmark\b/i, null, 5],
    ["mind-psychic",  /\bpsychic|\bmind\b|\bthought|\bmemory|\bego\b|\bintellect|\bsynapse|\bmindscape|\bbrain/i, /[[^]]*(mind-affecting|meditative|draconic)/i, 11],
    ["communication", /\bmessage|\bsending|\btongues|\bwhisper|\bspeak\b|\bcomprehend|\bdream\b|\btelepathic bond|\bshare\b/i, /\[[^\]]*language-dependent/i, 5],
    ["creation",      /\bcreate\b|\bfabricat|\bmajor creation|\bminor creation|\bwish\b|\bmiracle|\bpermanen|\bsecure shelter|\brope trick|\bmagnificent/i, /\(creation\)/i, 16],
    ["blood-flesh",   /\bblood\b|\bflesh\b|\bbone\b|\bvital|\borgan|\bgore\b|\bwound|\brend\b|\bharm\b|\binflict/i, null, 7],
    ["ritual-occult", /\britual|\boccult|\bceremony|\bcircle\b|\binvocation|\bbinding\b|\bseance/i, /Occult Ritual/i, 2],
    ["ability-buff",  /\bstrength|\bdexterity|\bconstitution|\bintelligence|\bwisdom|\bcharisma|\bcunning|\bsplendor|\bgrace\b|\bendurance|\bheroism|\bbless\b|\bprayer|\brage\b/i, null, 3],
    ["dispel-negate", /\bdispel|\bnegate|\bbreak enchantment|\bantimagic|\bnullify|\bdismiss/i, null, 1],
    ["trap-alarm",    /\balarm|\btrap\b|\bsnare|\bguards and wards|\bforbiddance|\bhallow|\bunhallow/i, null, 2]
  ],
  ...
  monsters: [
    ...
    ["animal-bigcat", /\bcat\b|\blion|\btiger|\bleopard|\bpanther|\bcheetah|\blynx|\bjaguar|\bsmilodon/i, null, 6],
    ["animal-canine", /\bdog\b|\bwolf|\bjackal|\bhyena|\bfox\b|\bcoyote|\bdire wolf/i, null, 4],
    ["animal-bear",   /\bbear\b|\bbadger|\bwolverine|\bboar\b|\bpig\b|\bhog\b/i, null, 2],
    ["animal-bird",   /\bbird\b|\beagle|\bhawk\b|\bowl\b|\braven|\bfalcon|\bvulture|\bcondor|\bparrot|\broc\b|\baxe beak|\barchaeop/i, null, 4],
    ["animal-reptile",/\blizard|\bsnake|\bviper|\bcrocodile|\balligator|\bturtle|\btortoise|\bmonitor|\bcobra|\bpython|\bdinosaur|\bsaurus|\braptor|\bceratops/i, null, 9],
    ["animal-aquatic",/\bfish\b|\bshark|\bdolphin|\bwhale|\boctopus|\bsquid|\bcrab\b|\beel\b|\bmanta|\bseal\b|\bwalrus|\bangler|\bstingray/i, null, 8],
    ["animal-insect", /\bant\b|\bbeetle|\bspider|\bscorpion|\bwasp|\bbee\b|\bmantis|\bcentipede|\bfly\b|\bbug\b|\bmoth\b|\btick\b|\blocust/i, null, 12],
    ["animal-hoofed", /\bhorse|\bpony|\bcamel|\belk\b|\bdeer|\bstag\b|\bantelope|\bgoat|\bram\b|\bbison|\bbull\b|\box\b|\bmoose|\brhino|\bhippo|\belephant|\bmammoth/i, null, 7],
    ["animal-primate",/\bape\b|\bmonkey|\bbaboon|\bgorilla|\bchimp|\blemur/i, null, 2],
    ["animal-small",  /\brat\b|\bmouse|\bweasel|\bferret|\bbat\b|\bhare|\brabbit|\bsquirrel|\bmole\b|\bhedgehog|\botter|\bskunk/i, null, 5],
    // Templates — creature modifiers, not creatures.
    ["template-undead",/\bundead|\blich|\bvampir|\bghost|\bskeleton|\bzombie|\bghoul|\bshade\b|\bwraith|\bmummy|\brevenant|\bhaunt/i, null, 19],
    ["template-fiend",/\bfiend|\bdemon|\bdevil|\bdaemon|\bkyton|\binfernal|\babyssal|\bhalf-fiend|\baccursed|\bcorrupt/i, null, 21],
    ["template-celestial",/\bcelestial|\bangel|\bempyreal|\bholy\b|\bblessed|\bhalf-celestial|\bapostle/i, null, 2],
    ["template-elemental",/\belemental|\bfire\b|\bfrost\b|\bice\b|\bmagma|\bstorm\b|\bthunder|\baqueous|\baerial|\bearth\b/i, null, 14],
    ["template-beast",/\bbeast\b|\banimal|\bferal|\bsavage|\bdire\b|\blycanthrop|\bwere\b|\bprimal|\btotem/i, null, 7],
    ["template-construct",/\bconstruct|\bclockwork|\bgolem|\bautomaton|\banimated|\bmechanic/i, null, 20],
    ["template-mutation",/\bmutant|\bevolved|\bawakened|\bvariant\b|\balter ego|\bmythic|\badvanced\b/i, null, 11],
    ...
    ["umr-affliction",/\bdisease|\bpoison|\bparalys|\bpetrif|\benergy drain|\babilit(y|ies) (damage|drain)|\bfear\b|\bstench/i, null, 2]
  ]
};
...
window.PF_VARIETY = {
  ...
  "opt-stares": 2,
  "opt-tricks": 3,
  "opt-unique-patrons": 1, "opt-mythic-path": 32,
  "opt-wild-talents": 21,
  "school-abjuration": 15,
  "school-conjuration": 3,
  "school-divination": 20,
  "school-enchantment": 2,
  "school-evocation": 11,
  "school-illusion": 2,
  "school-necromancy": 14,
  "school-transmutation": 62,
  "trait-campaign": 3,
  "trait-combat": 10,
  "trait-cosmic": 1,
  "trait-drawback": 1,
  ...
  "item-body": 2,
  "item-neck": 3,
  "rules": 335,          // rules pages have no category to sort them by
  "npc": 12,
  "feat-scene": 154,     // feats matching no theme (725 of them)
  "item-scene": 38,     // mundane goods: Miscellaneous, Equipment, Magic Equipment
  "item-wondrous": 44,  // wondrous items no theme or slot caught
...
window.PF_BODY_THEMES = {
  ...
  options: [
    ...
    ["domain-power",    /\bdomain (power|spell)s?\b/i, 4],
